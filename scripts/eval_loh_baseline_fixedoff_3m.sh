...
#     bash scripts/eval_loh_baseline_fixedoff_3m.sh data/WikiCDN/wiki_2019t.oracleGeneral.zst 0.1
...
echo "[2/2] evaluate baseline LOH (no RL, no LOH_FIXED_WEIGHTS)"
export LOH_ENABLE_RL=0
unset LOH_FIXED_WEIGHTS || true
