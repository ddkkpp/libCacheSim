...
OUT_DIR="tmp/log1p_qinput_orig3_cache0001_0317"
...
echo "[start] 27.6 config + original 3 traces + cache_size=0.001 + hitmiss=0" >> "$RUNNER_LOG"
...
run_one() {
  local trace_name="$1"
  local trace_path="$2"
  local case_name="${trace_name}_log1p_qinput_log1p_hitmiss0_c001"
  local case_stamp
