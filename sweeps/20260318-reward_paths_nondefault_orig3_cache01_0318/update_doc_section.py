...
BEGIN = "<!-- AUTO_REWARD_PATHS_NONDEFAULT_ORIG3_CACHE01_0318_BEGIN -->"
END = "<!-- AUTO_REWARD_PATHS_NONDEFAULT_ORIG3_CACHE01_0318_END -->"
...
def sort_key(row):
    ...
    trace = row.get("trace", "")
    return (trace_order.get(trace, 99), trace, row.get("path", ""))
...
def build_block(csv_path, rows):
    ...
    lines = [
        ...
        "",
        "| Trace | Path | RewardMode | UseMiss | MissMode | UseTrend | TrendMode | Final MR | Byte MR | MQPS | Log |",
        "|:--|:--|:--|---:|:--|---:|:--|---:|---:|---:|---|",
    ]
