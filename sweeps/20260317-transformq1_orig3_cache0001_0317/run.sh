...
OUT_DIR="tmp/transformq1_orig3_cache0001_0317"
...
echo "[start] transform_quantile=1 + orig3 + cache=0.001 + hitmiss=0" >> "$RUNNER_LOG"
...
COMMON_ENV=(
  ...
  "LOH_ADAPTIVE_NORM_TRANSFORM_QUANTILE=1"
...
run_one() {
  local trace_name="$1"
  local trace_path="$2"
  local case_name="${trace_name}_transformq1_cache0001"
  local case_stamp
