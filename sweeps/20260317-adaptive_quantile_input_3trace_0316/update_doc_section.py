...
BEGIN = "<!-- AUTO_ADAPTIVE_QINPUT_3TRACE_0316_BEGIN -->"
END = "<!-- AUTO_ADAPTIVE_QINPUT_3TRACE_0316_END -->"
...
def build_block(csv_path, rows):
    ...
    for row in sorted(rows, key=lambda r: (r.get("trace", ""), r.get("q_input", ""))):
        ...
        lines.append(
            "| {} | `log1p` | `adpt(q={},lo0,hi1,w0)` | {} | {} | {} | `{}` |".format(
                row.get("trace", ""),
                row.get("q_input", ""),
