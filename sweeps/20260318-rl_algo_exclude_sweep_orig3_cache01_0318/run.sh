...
OUT_DIR="tmp/rl_algo_exclude_sweep_orig3_cache01_0318"
...
echo "[start] rl_algo x exclude_recent_steps sweep + orig3 + cache=0.1" >> "$RUNNER_LOG"
...
ALGOS_WITH_EXCLUDE=("SAC" "TD3" "DDPG" "DQN")
ALGOS_NO_EXCLUDE=("PPO" "A2C")
