...
# 使用说明函数
usage() {
    echo "Usage: $0 [trace_file] [state_dim] [cache_size] [miss_ratio_weight] [python_script]"
    ...
    echo "  $0 /path/to/trace.gz 26 0.2 0.8 loh_actor_critic_sb3_SACblocked.py  # Use blocked version"
