# 画图注意事项（cache-size=0.001 / fixxxx / v7_3lcache-target）

## 数据源目录

- 各组 markdown：`docs/20260423-ablation-per-group-fixxxx-cache0001/cmaes版本LOH/<group>.md`
...
```
generate_plots.py   # 本文件同目录，原始位于 tmp/20260423-robustness-figures/generate_plots_autocompound_cache0001_v7_3lcache_target.py
```
...
PATH="$PWD/.venv/bin:$PATH" python3 \
    tmp/20260507-robustness-figures-fixxxx-cache0001-v7-3lcache-target/generate_plots.py
```
