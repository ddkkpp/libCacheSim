...
## 相关文档
- [PENALTY_MECHANISM_REDESIGN.md](./PENALTY_MECHANISM_REDESIGN.md) - 详细设计方案
- [TUNING_GUIDE.md](./TUNING_GUIDE.md) - 参数调优指南
- [SAMPLING_EXCLUSION_STRATEGY.md](./SAMPLING_EXCLUSION_STRATEGY.md) - 采样策略说明
