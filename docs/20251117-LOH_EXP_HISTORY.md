...
- **尝试 / 改动**
  - 梳理并文档化环境变量：
    - 在 `docs/20251114-LOH_ENV_VARS.md` 中总结 LOH 相关环境变量，包括：IPC/共享内存、信号量开关、状态维度、奖励配置、脚本参数等，并标注默认值。
...
- **阶段性结论 / 下一步计划**
  ...
  - 建议的下一步：
    - 正式在文档（如 `20251114-LOH_ENV_VARS.md`）中加入 FEATURE_LOG 的说明（默认 0，作用于 6 个特征）；
    - 设计一组基础对照实验矩阵，如：
...
- **功能改动**
  - 创建并维护 `docs/20251114-LOH_ENV_VARS.md`：
