...
│   ├── 20251028-20251028-README.md             # 脚本使用说明
│   ├── 10282046-test_reward_improvement.sh
│   └── ...
├── docs/                      # 说明文档（按时间戳命名）
│   ├── 20251028-20251028-README.md             # 文档索引
│   ├── 20251028-20251028-REWARD_IMPROVEMENT_PLAN.md  # ⭐ 最新改进方案
│   ├── 20251027-20251027-PENALTY_QUEUE_OPTIMIZATION.md
│   └── ...
└── 20251028-20251028-DOC_INDEX.md              # 本文件
```
...
### 必读（按优先级）
1. **[奖励改进方案](docs/20251028-20251028-REWARD_IMPROVEMENT_PLAN.md)** ⭐ 最新
   - 解决reward缺乏差异性问题
   - 纯penalty-based奖励公式
   - 连续运行策略

2. **[测试脚本说明](test_scripts/20251028-20251028-README.md)**
   - 各个测试脚本的用途
   - 使用方法和注意事项

3. **[文档索引](docs/20251028-20251028-README.md)**
   - 所有文档的分类和阅读顺序
   - 快速参考配置

### 进阶阅读
- [SAC算法回顾](docs/20251022-20251022-SAC_RETROSPECTIVE_GUIDE.md) - 算法原理
- [超参数调优](docs/20251023-20251023-TUNING_GUIDE.md) - 调优技巧
- [Ctrl+C行为](docs/20251024-20251024-CTRL_C_BEHAVIOR.md) - 优雅停止

### 问题排查
- [Penalty修复总结](docs/20251023-20251023-PENALTY_FIXES_SUMMARY.md)
- [时间戳改进](docs/20251023-20251023-EVICTION_TIMESTAMP_IMPROVEMENT.md)
...
| 环境变量 | 默认值 | 说明 |
|---------|-------|------|
| `LOH_ENABLE_FEATURE_NORMALIZATION` | 0 | 启用固定 `log1p(max)` 归一化 |
| `LOH_ENABLE_ADAPTIVE_FEATURE_NORMALIZATION` | 0 | 启用基于在线分位数的自适应归一化 |
| `LOH_ADAPTIVE_NORM_LO_Q` | 0.01 | 自适应归一化下界分位数 |
| `LOH_ADAPTIVE_NORM_HI_Q` | 0.99 | 自适应归一化上界分位数 |
| `LOH_ADAPTIVE_NORM_WARMUP` | 4096 | 自适应归一化生效前最小样本数 |
...
### 示例
- `20251028-20251028-REWARD_IMPROVEMENT_PLAN.md` = 2025年10月28日 20:26
