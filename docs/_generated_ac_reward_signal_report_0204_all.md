...
**Summary**
- immediate_reward: n=640196, mean=0.759671, bins=[0,0.25):8.82% [0.25,0.5):11.00% [0.5,0.75):19.69% [0.75,1):60.49%
...
- **ac_sb3_0204_020749.log**
  ...
  - penalty_data: n=0, zero=0 (n/a), hist=n/a
  - immediate_reward: n=29158, mean=0.791848, min=0.015, max=1, p50=0.985, p90=1, p99=1
  - immediate_reward bins: [0,0.25):2.86% [0.25,0.5):14.25% [0.5,0.75):20.98% [0.75,1):61.91%
  ...
  - penalty bins: n/a
- **ac_sb3_0204_021931.log**
  - params: LOH_ENABLE_PENALTY=0<br>byte_penalty=0.000<br>obj_penalty=1.000
  - note: penalty disabled (so penalty_data/final_reward may be absent)
  - penalty_data: n=0, zero=0 (n/a), hist=n/a
  - immediate_reward: n=29158, mean=0.792509, min=0.015, max=1, p50=1, p90=1, p99=1
  - immediate_reward bins: [0,0.25):2.77% [0.25,0.5):14.23% [0.5,0.75):21.13% [0.75,1):61.87%
  - reward(before clip): n=0, mean=n/a, min=n/a, max=n/a, p50=n/a, p90=n/a, p99=n/a
  - final_reward(after clip): n=0, mean=n/a, min=n/a, max=n/a, clip_sat=n/a, p50=n/a, p90=n/a, p99=n/a
  - final_reward bins: n/a
  - penalty(weighted): n=0, mean=n/a, min=n/a, max=n/a, p50=n/a, p90=n/a, p99=n/a
  - penalty bins: n/a
- **ac_sb3_0204_025647.log**
  - params: LOH_ENABLE_PENALTY=0<br>byte_penalty=0.000<br>obj_penalty=1.000
  - note: penalty disabled (so penalty_data/final_reward may be absent)
  - penalty_data: n=0, zero=0 (n/a), hist=n/a
  - immediate_reward: n=0, mean=n/a, min=n/a, max=n/a, p50=n/a, p90=n/a, p99=n/a
  - immediate_reward bins: n/a
  - reward(before clip): n=0, mean=n/a, min=n/a, max=n/a, p50=n/a, p90=n/a, p99=n/a
  - final_reward(after clip): n=0, mean=n/a, min=n/a, max=n/a, clip_sat=n/a, p50=n/a, p90=n/a, p99=n/a
  - final_reward bins: n/a
  - penalty(weighted): n=0, mean=n/a, min=n/a, max=n/a, p50=n/a, p90=n/a, p99=n/a
  - penalty bins: n/a
- **ac_sb3_0204_030249.log**
  - params: LOH_ENABLE_PENALTY=0<br>byte_penalty=0.000<br>obj_penalty=1.000
  - note: penalty disabled (so penalty_data/final_reward may be absent)
  - penalty_data: n=0, zero=0 (n/a), hist=n/a
  - immediate_reward: n=29158, mean=0.792509, min=0.015, max=1, p50=1, p90=1, p99=1
...
- **ac_sb3_0204_091918.log**
  ...
  - penalty(weighted): n=0, mean=n/a, min=n/a, max=n/a, p50=n/a, p90=n/a, p99=n/a
  - penalty bins: n/a
- **ac_sb3_0204_093027.log**
  - params: LOH_ENABLE_PENALTY=0<br>byte_penalty=0.000<br>obj_penalty=1.000
  - note: penalty disabled (so penalty_data/final_reward may be absent)
  - penalty_data: n=0, zero=0 (n/a), hist=n/a
  - immediate_reward: n=29158, mean=0.792481, min=0.015, max=1, p50=1, p90=1, p99=1
  - immediate_reward bins: [0,0.25):2.79% [0.25,0.5):14.26% [0.5,0.75):21.03% [0.75,1):61.92%
  - reward(before clip): n=0, mean=n/a, min=n/a, max=n/a, p50=n/a, p90=n/a, p99=n/a
  - final_reward(after clip): n=0, mean=n/a, min=n/a, max=n/a, clip_sat=n/a, p50=n/a, p90=n/a, p99=n/a
  - final_reward bins: n/a
  - penalty(weighted): n=0, mean=n/a, min=n/a, max=n/a, p50=n/a, p90=n/a, p99=n/a
  - penalty bins: n/a
- **ac_sb3_0204_093436.log**
  - params: LOH_ENABLE_PENALTY=0<br>byte_penalty=0.000<br>obj_penalty=1.000
  - note: penalty disabled (so penalty_data/final_reward may be absent)
  - penalty_data: n=0, zero=0 (n/a), hist=n/a
  - immediate_reward: n=29158, mean=0.792663, min=0.015, max=1, p50=1, p90=1, p99=1
  - immediate_reward bins: [0,0.25):2.83% [0.25,0.5):14.10% [0.5,0.75):21.09% [0.75,1):61.99%
  - reward(before clip): n=0, mean=n/a, min=n/a, max=n/a, p50=n/a, p90=n/a, p99=n/a
  - final_reward(after clip): n=0, mean=n/a, min=n/a, max=n/a, clip_sat=n/a, p50=n/a, p90=n/a, p99=n/a
  - final_reward bins: n/a
  - penalty(weighted): n=0, mean=n/a, min=n/a, max=n/a, p50=n/a, p90=n/a, p99=n/a
  - penalty bins: n/a
- **ac_sb3_0204_300k_1063_topk_s124_p0.log**
  - params: LOH_ENABLE_PENALTY=0<br>byte_penalty=0.000<br>obj_penalty=1.000
  - note: penalty disabled (so penalty_data/final_reward may be absent)
  - penalty_data: n=0, zero=0 (n/a), hist=n/a
  - immediate_reward: n=2904, mean=0.676563, min=0, max=1, p50=1, p90=1, p99=1
  - immediate_reward bins: [0,0.25):20.11% [0.25,0.5):17.46% [0.5,0.75):8.99% [0.75,1):53.44%
  - reward(before clip): n=0, mean=n/a, min=n/a, max=n/a, p50=n/a, p90=n/a, p99=n/a
  - final_reward(after clip): n=0, mean=n/a, min=n/a, max=n/a, clip_sat=n/a, p50=n/a, p90=n/a, p99=n/a
  - final_reward bins: n/a
  - penalty(weighted): n=0, mean=n/a, min=n/a, max=n/a, p50=n/a, p90=n/a, p99=n/a
...
- **ac_sb3_0204_3m_1063_avgtopk_s124_p0.log**
  ...
  - note: penalty disabled (so penalty_data/final_reward may be absent)
  - penalty_data: n=0, zero=0 (n/a), hist=n/a
  - immediate_reward: n=29158, mean=0.782567, min=0.015, max=1, p50=1, p90=1, p99=1
...
- **ac_sb3_0204_3m_1063_state2_nosoft_s125_p0.log**
  ...
  - note: penalty disabled (so penalty_data/final_reward may be absent)
  - penalty_data: n=0, zero=0 (n/a), hist=n/a
  - immediate_reward: n=29158, mean=0.819793, min=0.005, max=1, p50=0.98, p90=1, p99=1
...
- **ac_sb3_0204_3m_1063_state2_nosoft_sign0_s124_p0.log**
  ...
  - note: penalty disabled (so penalty_data/final_reward may be absent)
  - penalty_data: n=0, zero=0 (n/a), hist=n/a
  - immediate_reward: n=29158, mean=0.821235, min=0, max=1, p50=0.985, p90=1, p99=1
  - immediate_reward bins: [0,0.25):1.90% [0.25,0.5):10.32% [0.5,0.75):20.03% [0.75,1):67.75%
  - reward(before clip): n=0, mean=n/a, min=n/a, max=n/a, p50=n/a, p90=n/a, p99=n/a
  - final_reward(after clip): n=0, mean=n/a, min=n/a, max=n/a, clip_sat=n/a, p50=n/a, p90=n/a, p99=n/a
  - final_reward bins: n/a
...
- **ac_sb3_0204_3m_1063_topk_nomiss_s124_p0.log**
  ...
  - note: penalty disabled (so penalty_data/final_reward may be absent)
  - penalty_data: n=0, zero=0 (n/a), hist=n/a
  - immediate_reward: n=29158, mean=0.782609, min=0.015, max=1, p50=1, p90=1, p99=1
...
- **ac_sb3_0204_3m_1063_topk_s124_p0.log**
  ...
  - note: penalty disabled (so penalty_data/final_reward may be absent)
  - penalty_data: n=0, zero=0 (n/a), hist=n/a
  - immediate_reward: n=29158, mean=0.78357, min=0.015, max=1, p50=0.995, p90=1, p99=1
...
- **ac_sb3_0204_3m_cloud_w01_state2_nosoft_s124_p0.log**
  ...
  - note: penalty disabled (so penalty_data/final_reward may be absent)
  - penalty_data: n=0, zero=0 (n/a), hist=n/a
  - immediate_reward: n=28442, mean=0.58416, min=0, max=1, p50=0.995, p90=1, p99=1
...
- **ac_sb3_0204_3m_cloud_w01_state2_nosoft_s125_p0.log**
  ...
  - note: penalty disabled (so penalty_data/final_reward may be absent)
  - penalty_data: n=0, zero=0 (n/a), hist=n/a
  - immediate_reward: n=28442, mean=0.586473, min=0, max=1, p50=0.9525, p90=1, p99=1
...
- **ac_sb3_0204_3m_cloud_w01_state2_soft_s124_p0.log**
  ...
  - note: penalty disabled (so penalty_data/final_reward may be absent)
  - penalty_data: n=0, zero=0 (n/a), hist=n/a
  - immediate_reward: n=28442, mean=0.559352, min=0, max=1, p50=0.99, p90=1, p99=1
...
- **ac_sb3_0204_3m_meta_reag_state2_soft_s124_p0.log**
  ...
  - penalty(weighted): n=0, mean=n/a, min=n/a, max=n/a, p50=n/a, p90=n/a, p99=n/a
  - penalty bins: n/a
- **ac_sb3_0204_diag_1063_p0_s124.log**
  - params: LOH_ENABLE_PENALTY=0<br>byte_penalty=0.000<br>obj_penalty=1.000
  - note: penalty disabled (so penalty_data/final_reward may be absent)
  - penalty_data: n=0, zero=0 (n/a), hist=n/a
  - immediate_reward: n=2904, mean=0.676563, min=0, max=1, p50=1, p90=1, p99=1
...
**Summary**
- immediate_reward: n=90378, mean=0.785509, bins=[0,0.25):3.55% [0.25,0.5):14.75% [0.5,0.75):20.48% [0.75,1):61.23%
...
- **ac_sb3_0204_023003.log**
  ...
  - immediate_reward: n=29158, mean=0.791782, min=0.015, max=1, p50=0.98, p90=1, p99=1
...
- **ac_sb3_0204_102923.log**
  ...
  - immediate_reward: n=29158, mean=0.792226, min=0.015, max=1, p50=1, p90=1, p99=1
...
- **ac_sb3_0204_300k_1063_p1_pen_log_w0p1_centered_orig1_s124.log**
  - params: LOH_ENABLE_PENALTY=1<br>LOH_PENALTY_MODE/LOH_PENALTY_SCALE=log<br>LOH_REWARD_USE_PENALTY=1<br>LOH_REWARD_W_PENALTY=0.1<br>byte_penalty=0.000<br>obj_penalty=1.000<br>penalty_entry_size=32)<br>penalty_reward_formula=centered<br>penalty_scale=log_compressed
  - penalty_data: n=0, zero=0 (n/a), hist=n/a
  - immediate_reward: n=2904, mean=0.676563, min=0, max=1, p50=1, p90=1, p99=1
  - immediate_reward bins: [0,0.25):20.11% [0.25,0.5):17.46% [0.5,0.75):8.99% [0.75,1):53.44%
  - reward(before clip): n=0, mean=n/a, min=n/a, max=n/a, p50=n/a, p90=n/a, p99=n/a
...
**Summary**
- immediate_reward: n=183806, mean=0.783579, bins=[0,0.25):3.93% [0.25,0.5):14.63% [0.5,0.75):20.30% [0.75,1):61.15%
...
- **ac_sb3_0204_015727.log**
  - params: LOH_ENABLE_PENALTY=1<br>LOH_PENALTY_MODE/LOH_PENALTY_SCALE=reciprocal<br>LOH_REWARD_USE_PENALTY=1<br>LOH_REWARD_W_PENALTY=1.0<br>byte_penalty=0.000<br>obj_penalty=1.000<br>penalty_entry_size=32)<br>penalty_scale=reciprocal
  - penalty_data: n=0, zero=0 (n/a), hist=n/a
  - immediate_reward: n=1918, mean=0.645474, min=0, max=1, p50=0.99, p90=1, p99=1
  - immediate_reward bins: [0,0.25):25.76% [0.25,0.5):16.21% [0.5,0.75):6.15% [0.75,1):51.88%
  - reward(before clip): n=0, mean=n/a, min=n/a, max=n/a, p50=n/a, p90=n/a, p99=n/a
  - final_reward(after clip): n=0, mean=n/a, min=n/a, max=n/a, clip_sat=n/a, p50=n/a, p90=n/a, p99=n/a
  - final_reward bins: n/a
  - penalty(weighted): n=0, mean=n/a, min=n/a, max=n/a, p50=n/a, p90=n/a, p99=n/a
  - penalty bins: n/a
- **ac_sb3_0204_020044.log**
  - params: LOH_ENABLE_PENALTY=1<br>LOH_PENALTY_MODE/LOH_PENALTY_SCALE=reciprocal<br>LOH_REWARD_USE_PENALTY=1<br>LOH_REWARD_W_PENALTY=1.0<br>byte_penalty=0.000<br>obj_penalty=1.000<br>penalty_entry_size=32)<br>penalty_scale=reciprocal
  - penalty_data: n=0, zero=0 (n/a), hist=n/a
  - immediate_reward: n=1132, mean=0.62064, min=0, max=1, p50=0.995, p90=1, p99=1
  - immediate_reward bins: [0,0.25):31.54% [0.25,0.5):12.63% [0.5,0.75):3.98% [0.75,1):51.86%
  - reward(before clip): n=0, mean=n/a, min=n/a, max=n/a, p50=n/a, p90=n/a, p99=n/a
  - final_reward(after clip): n=0, mean=n/a, min=n/a, max=n/a, clip_sat=n/a, p50=n/a, p90=n/a, p99=n/a
  - final_reward bins: n/a
  - penalty(weighted): n=0, mean=n/a, min=n/a, max=n/a, p50=n/a, p90=n/a, p99=n/a
...
- **ac_sb3_0204_020116.log**
  ...
  - immediate_reward: n=29158, mean=0.792282, min=0.015, max=1, p50=1, p90=1, p99=1
...
- **ac_sb3_0204_022347.log**
  ...
  - immediate_reward: n=29158, mean=0.792151, min=0.015, max=1, p50=1, p90=1, p99=1
...
- **ac_sb3_0204_023929.log**
  - params: LOH_PENALTY_MODE/LOH_PENALTY_SCALE=reciprocal<br>LOH_REWARD_USE_PENALTY=1<br>LOH_REWARD_W_PENALTY=0.25<br>byte_penalty=0.000<br>obj_penalty=1.000
  - note: penalty enabled/disabled not found in log
  - penalty_data: n=0, zero=0 (n/a), hist=n/a
  - immediate_reward: n=0, mean=n/a, min=n/a, max=n/a, p50=n/a, p90=n/a, p99=n/a
  - immediate_reward bins: n/a
  - reward(before clip): n=0, mean=n/a, min=n/a, max=n/a, p50=n/a, p90=n/a, p99=n/a
...
- **ac_sb3_0204_103522.log**
  ...
  - immediate_reward: n=29158, mean=0.79229, min=0.015, max=1, p50=1, p90=1, p99=1
...
- **ac_sb3_0204_300k_1063_p1_pen_default_s124.log**
  - params: LOH_ENABLE_PENALTY=1<br>LOH_PENALTY_MODE/LOH_PENALTY_SCALE=reciprocal<br>LOH_REWARD_USE_PENALTY=1<br>LOH_REWARD_W_PENALTY=1.0<br>byte_penalty=0.000<br>obj_penalty=1.000<br>penalty_entry_size=32)<br>penalty_reward_formula=relative<br>penalty_scale=reciprocal
  - penalty_data: n=0, zero=0 (n/a), hist=n/a
  - immediate_reward: n=2904, mean=0.676563, min=0, max=1, p50=1, p90=1, p99=1
  - immediate_reward bins: [0,0.25):20.11% [0.25,0.5):17.46% [0.5,0.75):8.99% [0.75,1):53.44%
  - reward(before clip): n=0, mean=n/a, min=n/a, max=n/a, p50=n/a, p90=n/a, p99=n/a
...
- **ac_sb3_0204_diag_1063_p1_nopen_s124.log**
  - params: LOH_ENABLE_PENALTY=1<br>LOH_PENALTY_MODE/LOH_PENALTY_SCALE=reciprocal<br>LOH_REWARD_USE_PENALTY=0<br>LOH_REWARD_W_PENALTY=1.0<br>byte_penalty=0.000<br>obj_penalty=1.000<br>penalty_reward_formula=relative<br>penalty_scale=reciprocal
  - penalty_data: n=0, zero=0 (n/a), hist=n/a
  - immediate_reward: n=2904, mean=0.676563, min=0, max=1, p50=1, p90=1, p99=1
  - immediate_reward bins: [0,0.25):20.11% [0.25,0.5):17.46% [0.5,0.75):8.99% [0.75,1):53.44%
...
- **ac_sb3_0204_025109.log**
  - params: LOH_PENALTY_MODE/LOH_PENALTY_SCALE=survival<br>LOH_REWARD_USE_PENALTY=1<br>LOH_REWARD_W_PENALTY=0.25<br>byte_penalty=0.000<br>obj_penalty=1.000
  - note: penalty enabled/disabled not found in log
  - penalty_data: n=0, zero=0 (n/a), hist=n/a
  - immediate_reward: n=0, mean=n/a, min=n/a, max=n/a, p50=n/a, p90=n/a, p99=n/a
  - immediate_reward bins: n/a
...
- **ac_sb3_0204_094504.log**
  ...
  - immediate_reward: n=29158, mean=0.792169, min=0.015, max=1, p50=1, p90=1, p99=1
...
- **ac_sb3_0204_095110.log**
  ...
  - immediate_reward: n=29158, mean=0.792834, min=0.015, max=1, p50=0.995, p90=1, p99=1
...
- **ac_sb3_0204_100753.log**
  ...
  - immediate_reward: n=29158, mean=0.792273, min=0.015, max=1, p50=0.985, p90=1, p99=1
...
- **ac_sb3_0204_101659.log**
  ...
  - immediate_reward: n=29158, mean=0.792318, min=0.015, max=1, p50=0.99, p90=1, p99=1
...
- **ac_sb3_0204_102313.log**
  ...
  - immediate_reward: n=29158, mean=0.792345, min=0.015, max=1, p50=0.995, p90=1, p99=1
