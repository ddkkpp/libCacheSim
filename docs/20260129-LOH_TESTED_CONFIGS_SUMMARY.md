...
说明：扫描 `sweeps/` 下全部 `results.csv` 与 `combined_summary.csv`，按目录名推断日期并倒序排列；另外把仓库里较早的“非 sweeps 目录”的遗留汇总（如 [20251205-20251205-sweep_results.md](20251205-20251205-sweep_results.md)、[docs/20251205-20251205-sweep_results.md](docs/20251205-20251205-sweep_results.md)、[runs/20251205-20251205-sweep_results.md](runs/20251205-20251205-sweep_results.md)）也补入（这类记录通常缺失精确日期，统一标为 `unknown` 并放在表尾）。为避免横向滚动，`trace` 列使用短标识（完整 `trace_file` 以 CSV 为准，或见下方各 trace 章节标题）。
...
| unknown | const_weights_mr_blocked | MetaCDN/meta_reag | - | 0.3680 | 0.2175 | LOH-mr-blocked const weights (Top20) | [docs](docs/20251205-20251205-sweep_results.md) | date 未记录 |
| unknown | const_weights_mr_blocked | WikiCDN/wiki_2019t | - | 0.5995 | 0.4778 | LOH-mr-blocked const weights (Top20) | [docs](docs/20251205-20251205-sweep_results.md) | date 未记录 |
| unknown | const_weights_mr_blocked | TencentCBS/1063 | - | 0.3971 | 0.3615 | LOH-mr-blocked const weights (Top20) | [docs](docs/20251205-20251205-sweep_results.md) | date 未记录 |
| unknown | legacy_sizebucket_weights | TencentCBS/1063 | 1 | 0.4369 | 0.5434 | size-buckets enabled, no transforms | [md](20251205-20251205-sweep_results.md) | date 未记录 |
| unknown | legacy_sizebucket_weights | MetaCDN/meta_reag | 1 | 0.3680 | 0.2186 | size-buckets enabled, no transforms | [md](20251205-20251205-sweep_results.md) | date 未记录 |
| unknown | legacy_sizebucket_weights | WikiCDN/wiki_2019t | 1 | 0.5940 | 0.4922 | size-buckets enabled, no transforms | [md](20251205-20251205-sweep_results.md) | date 未记录 |
...
| 固定权重最优（refine） | 0.323619 | 0.316550 | w=[1,0,2.5,0,0,0]（Compound） | [20260131-LOH_CONSTANT_WEIGHTS_BEST_3M_WIKI2019T_1063.md](20260131-LOH_CONSTANT_WEIGHTS_BEST_3M_WIKI2019T_1063.md) |
...
说明：这类实验不产生根目录的 `cachesim_sb3_*.log/ac_sb3_*.log` 对；日志与汇总 TSV 位于 `runs/constant_weight_norl_*`。更完整的说明见：[20260131-LOH_CONSTANT_WEIGHTS_BEST_3M_WIKI2019T_1063.md](20260131-LOH_CONSTANT_WEIGHTS_BEST_3M_WIKI2019T_1063.md)
